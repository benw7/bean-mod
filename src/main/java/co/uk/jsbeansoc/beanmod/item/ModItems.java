...
public class ModItems {
    ...
    public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato", () -> new Item(new Item.Properties().food(new Food.Builder().hunger(1).saturation(1).fastToEat().build()).maxStackSize(16).group(ItemGroup.FOOD)));
